...
void saveSetupMode ()
{
  writeFile ( "SetupMode.json", SetupMode );
}
void saveNames ()
{
  writeFile ( "Names.json", Names );
}
void saveAutorisation ()
{
  writeFile ( "Autorisation.json", Autorisation );
}
void saveVariables ()
{
  writeFile ( "Variables.json", Variables );
}
void saveIPs ()
{
  writeFile ( "IPadresses.json", IPadresses );
}
